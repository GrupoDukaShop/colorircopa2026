    ...
    <section className="py-20 md:py-28 px-5 bg-[#F0F4FF]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-[820px] mx-auto mt-11">
          ...
          {/* More pages card */}
          <div className="reveal delay-3 rounded-2xl border-2 border-dashed border-copa-green bg-copa-green/5 min-h-[300px] flex flex-col items-center justify-center gap-2 text-center p-6">
